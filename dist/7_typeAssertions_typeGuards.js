...
//Example:
//Basic Example:
let someValue = "follow me on github @muazimmaqbool";
...
let strLength = someValue.length; //works fine
// Method 2 using using <string>:
let strLength2 = someValue.length; //works
//Another example:
...
const strLength3 = rawData.length;
