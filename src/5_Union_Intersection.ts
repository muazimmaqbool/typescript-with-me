...
//1-> Union Types (OR):
type status = "pending" | "approved" | "rejected"; // the type 'status' can take only three values i.e one of the three values
...
// getStatus("loading") //error

type Branch = "CSE" | "Civil" | "Mechanical" | "Electrical" | "E & C";
function getInfo(branch: Branch) {
